...
import {SelectTechSubdivisionComponent} from '../select-tech-subdivision/select-tech-subdivision.component';

@Component({
  selector: 'app-new-tech-task-dialog',
  templateUrl: './new-tech-task-dialog.component.html',
  styleUrls: ['./new-tech-task-dialog.component.scss'],
  providers: [DesantEventsService, OlApiService, DialogService, LoaderService],
})
export class NewTechTaskDialogComponent implements OnInit {
